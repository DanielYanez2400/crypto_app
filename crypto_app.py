...
st.set_page_config(page_title='Crypto web app',page_icon=':grinning:',layout='wide')
...
expander_bar.markdown('''* **Python libraries:** pandas, numpy, os, seaborn, matplotlib, Image, base64, BeautifulSoup, requests, json, time, streamlit
* **Data source:** [CoinMarketCap](http://coinmarketcap.com).
* **Credit:** Web scraper adapted from the Medium article *[Web Scraping Crypto Prices With Python](https://towardsdatascience.com/web-scraping-crypto-prices-with-python-41072ea5b5bf)* written by [Bryan Feng](https://medium.com/@bryanf).''')

col1=st.sidebar

#columns((2,1)) col2 aspect ratio 2:1 col3
...
#WebScrapping data from CoinMarketCap
@st.cache
def load_data():
    ...
    listings_2=json.loads(coin_data['props']['initialState'])
    listings=listings_2['cryptocurrency']['listingLatest']['data']
